...
(function($, window, document, undefined) {
    ...
    NivoLightbox.prototype = {
        init: function() {
            ...
            if (this.options.keyboardNav) { $('body').off('keyup').on('keyup', function(e) { var code = (e.keyCode ? e.keyCode : e.which); if (code == 27) $this.destructLightbox(); if (code == 37) $('.nivo-lightbox-prev').trigger('click'); if (code == 39) $('.nivo-lightbox-next').trigger('click'); }); }
        ...
        checkContent: function(link) {
            ...
            if (href.match(/\.(jpeg|jpg|gif|png)$/i) !== null) { return true; } else if (video) { return true; } else if (link.attr('data-lightbox-type') == 'ajax') { return true; } else if (href.substring(0, 1) == '#' && link.attr('data-lightbox-type') == 'inline') { return true; } else if (link.attr('data-lightbox-type') == 'iframe') { return true; }
            return false;
        },
        processContent: function(content, link) {
            ...
            if (href.match(/\.(jpeg|jpg|gif|png)$/i) !== null) {
                ...
                if (src) {
                    var iframeVideo = $('<iframe>', { src: src, 'class': classTerm, frameborder: 0, vspace: 0, hspace: 0, scrolling: 'auto' });
                ...
                var iframe = $('<iframe>', { src: href, 'class': 'nivo-lightbox-item', frameborder: 0, vspace: 0, hspace: 0, scrolling: 'auto' });
                content.html(iframe);
        ...
        isHidpi: function() { var mediaQuery = "(-webkit-min-device-pixel-ratio: 1.5),\
