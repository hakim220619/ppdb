         ...
         <div class="row">
             ...
             <div class="col-lg-6 col-md-12 pl-0 pt-70 pr-5">
                 <div class="business-item-img">
                     <img src="https://preview.uideck.com/items/slick/business/img/business/business-img.png" class="img-fluid" alt="">
                 </div>
             </div>
                 ...
                 <div class="showcase-slider owl-carousel">
                     <div class="item">
                         <div class="screenshot-thumb">
                             <img src="https://preview.uideck.com/items/slick/business/img/showcase/01.jpg" class="img-fluid" alt="" />
                             <div class="hover-content text-center">
                                 <div class="fancy-table">
                                     <div class="table-cell">
                                         ...
                                         <div class="zoom-icon">
                                             <a class="lightbox" href="https://preview.uideck.com/items/slick/business/img/showcase/01.jpg"><i class="lni lni-zoom-in"></i></a>
                     ...
                     <div class="item">
                         <div class="screenshot-thumb">
                             <img src="https://preview.uideck.com/items/slick/business/img/showcase/02.jpg" class="img-fluid" alt="" />
                             <div class="hover-content text-center">
                                 <div class="fancy-table">
                                     <div class="table-cell">
                                         <div class="single-text">
                                         ...
                                         <div class="zoom-icon">
                                             <a class="lightbox" href="https://preview.uideck.com/items/slick/business/img/showcase/02.jpg"><i class="lni lni-zoom-in"></i></a>
                                             <a href="#"><i class="lni lni-link"></i></a>
                                         </div>
                                     </div>
                                 </div>
                     ...
                     <div class="item">
                         <div class="screenshot-thumb">
                             <img src="https://preview.uideck.com/items/slick/business/img/showcase/03.jpg" class="img-fluid" alt="" />
                             <div class="hover-content text-center">
                                 <div class="fancy-table">
                                     <div class="table-cell">
                                         <div class="single-text">
                                         ...
                                         <div class="zoom-icon">
                                             <a class="lightbox" href="https://preview.uideck.com/items/slick/business/img/showcase/03.jpg"><i class="lni lni-zoom-in"></i></a>
                                             <a href="#"><i class="lni lni-link"></i></a>
                                         </div>
                                     </div>
                                 </div>
                     ...
                     <div class="item">
                         <div class="screenshot-thumb">
                             <img src="https://preview.uideck.com/items/slick/business/img/showcase/04.jpg" class="img-fluid" alt="" />
                             <div class="hover-content text-center">
                                 <div class="fancy-table">
                                     <div class="table-cell">
                                         <div class="single-text">
                                         ...
                                         <div class="zoom-icon">
                                             <a class="lightbox" href="https://preview.uideck.com/items/slick/business/img/showcase/04.jpg"><i class="lni lni-zoom-in"></i></a>
                                             <a href="#"><i class="lni lni-link"></i></a>
                                         </div>
                                     </div>
                                 </div>
                     ...
                     <div class="item">
                         <div class="screenshot-thumb">
                             <img src="https://preview.uideck.com/items/slick/business/img/showcase/05.jpg" class="img-fluid" alt="" />
                             <div class="hover-content text-center">
                                 <div class="fancy-table">
                                     <div class="table-cell">
                                         <div class="single-text">
                                         ...
                                         <div class="zoom-icon">
                                             <a class="lightbox" href="https://preview.uideck.com/items/slick/business/img/showcase/05.jpg"><i class="lni lni-zoom-in"></i></a>
                                             <a href="#"><i class="lni lni-link"></i></a>
                                         </div>
                                     </div>
                                 </div>
                     ...
                     <div class="item">
                         <div class="testimonial-item">
                             <div class="content-inner">
                                 <p class="description">Appropriately implement one-to-one catalysts for change <br class="d-none d-xl-block"> vis-a-vis wireless
                             ...
                             <div class="client-thumb">
                                 <img src="https://preview.uideck.com/items/slick/business/img/testimonial/01.png" alt="">
                             </div>
                         </div>
                     </div>
                     <div class="item">
     ...
     <div class="container">
         ...
         <div class="row">
             ...
             <div class="col-lg-3 col-md-6 col-xs-12 col-sm-10 mx-auto">
                 <div class="single-team">
                     <div class="team-thumb">
                         <img src="https://preview.uideck.com/items/slick/business/img/team/01.jpg" class="img-fluid" alt="">
                     </div>
             ...
             <div class="col-lg-3 col-md-6 col-xs-12 col-sm-10 mx-auto">
                 <div class="single-team">
                     <div class="team-thumb">
                         <img src="https://preview.uideck.com/items/slick/business/img/team/02.jpg" class="img-fluid" alt="">
                     </div>
                     <div class="team-details">
                         <div class="team-social-icons">
                             <ul class="social-list">
             ...
             <div class="col-lg-3 col-md-6 col-xs-12 col-sm-10 mx-auto">
                 <div class="single-team">
                     <div class="team-thumb">
                         <img src="https://preview.uideck.com/items/slick/business/img/team/03.jpg" class="img-fluid" alt="">
                     </div>
                     <div class="team-details">
                         <div class="team-social-icons">
                             <ul class="social-list">
             ...
             <div class="col-lg-3 col-md-6 col-xs-12 col-sm-10 mx-auto">
                 <div class="single-team">
                     <div class="team-thumb">
                         <img src="https://preview.uideck.com/items/slick/business/img/team/04.jpg" class="img-fluid" alt="">
                     </div>
                     <div class="team-details">
                         <div class="team-social-icons">
                             <ul class="social-list">
         ...
         <div class="row justify-content-center justify-content-md-start">
             ...
             <div class="col-lg-4 col-md-6 col-sm-10 col-xs-12 blog-item">
                 ...
                 <div class="blog-item-wrapper">
                     <div class="blog-item-img">
                         <a href="https://preview.uideck.com/items/slick/business/single-post.html">
                             <img src="https://preview.uideck.com/items/slick/business/img/blog/01.jpg" class="img-fluid" alt="">
                         </a>
                     </div>
                     <div class="blog-item-text">
                         <h3><a href="https://preview.uideck.com/items/slick/business/single-post.html">How Slick Will Transform <br class="d-none d-xl-block">Your Business</a>
                         </h3>
             ...
             <div class="col-lg-4 col-md-6 col-sm-10 col-xs-12 blog-item">
                 ...
                 <div class="blog-item-wrapper">
                     <div class="blog-item-img">
                         <a href="https://preview.uideck.com/items/slick/business/single-post.html">
                             <img src="https://preview.uideck.com/items/slick/business/img/blog/02.jpg" class="img-fluid" alt="">
                         </a>
                     </div>
                     <div class="blog-item-text">
                         <h3><a href="https://preview.uideck.com/items/slick/business/single-post.html">Growth Techniques for <br class="d-none d-xl-block">New Startups</a></h3>
                         <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
                             industry.</p>
                         <a href="#" class="read-more">5 Min read</a>
                     </div>
             ...
             <div class="col-lg-4 col-md-6 col-sm-10 col-xs-12 blog-item">
                 ...
                 <div class="blog-item-wrapper">
                     <div class="blog-item-img">
                         <a href="https://preview.uideck.com/items/slick/business/single-post.html">
                             <img src="https://preview.uideck.com/items/slick/business/img/blog/03.jpg" class="img-fluid" alt="">
                         </a>
                     </div>
                     <div class="blog-item-text">
                         <h3><a href="https://preview.uideck.com/items/slick/business/single-post.html">Writing Professional <br class="d-none d-xl-block">Emails to Customers</a>
                         </h3>
                         <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
                             industry.</p>
                         <a href="#" class="read-more">5 Min read</a>
         ...
         <div class="row">
             ...
             <div class="col-lg-4 col-md-12">
                 <div class="contact-img">
                     <img src="https://preview.uideck.com/items/slick/business/img/contact/01.png" class="img-fluid" alt="">
                 </div>
             </div>
             ...
             <div class="row">
                 ...
                 <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-mb-12">
                     <div class="footer-logo">
                         <img src="https://preview.uideck.com/items/slick/business/img/footer-logo.png" alt="">
                     </div>
                 </div>
