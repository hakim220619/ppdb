                  ...
                  <div class="row">
                      ...
                      <div class="col-md-6">
                          ...
                          <div class="d-flex align-items-center">
                              ...
                              <a href="<?= base_url('admin/reset_password/' . $get_id->no_pendaftaran) ?>" class="btn btn-danger btn-round ml-auto" style="color: white;">
                          ...
                          <div class="card">
                              <a href="#datawali" class="d-block bg-warning border border-warning card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
